...
public class ProductVariantService {
	...
	private ProductTable mergeVariant(ProductTable existing, ProductVariantRequest request, long updatedAt) {
		return ProductTable.builder()
			...
			.colors(request.getColors() != null && !request.getColors().isEmpty() ? request.getColors() : existing.getColors())
			.size(StringUtils.hasText(request.getSize()) ? request.getSize() : existing.getSize())
