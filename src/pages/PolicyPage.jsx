      ...
      <div className="policy-container">
        ...
        <div className="policy-content">
          <p className="policy-intro">
            Tại Yameshop.com, chúng tôi mong muốn mang lại sự hài lòng tối đa cho khách hàng. Vì vậy, 
            chúng tôi cung cấp chính sách đổi hàng linh hoạt. Xin lưu ý, YaMe chỉ hỗ trợ đổi hàng và 
          ...
          <section className="policy-section">
            ...
            <div className="policy-subsection">
              <h3>Cách 2: Đổi hàng qua kênh Online (yameshop.com)</h3>
              <ul>
                <li><strong>Bước 1:</strong> Liên hệ hotline (028) 7307 1441 để được nhân viên hướng dẫn chi tiết.</li>
