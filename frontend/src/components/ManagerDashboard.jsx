...
const ManagerDashboard = () => {
  ...
  const fetchKpi = async (period) => {
    ...
    setKpiError(null);
    try {
      const res = await fetch(`https://44.205.22.2:8080/api/dashboard/stats?period=${encodeURIComponent(period)}`);
  ...
  const fetchBlogs = async () => {
    try {
      const res = await fetch('https://44.205.22.2:8080/api/blog');
  ...
  const fetchWarehousesAndInventory = async () => {
    try {
      const res = await fetch('https://44.205.22.2:8080/api/warehouses');
      ...
      if (Array.isArray(warehouses) && warehouses.length > 0) {
        ...
        if (warehouseId) {
          const invRes = await fetch(`https://44.205.22.2:8080/api/warehouses/${encodeURIComponent(warehouseId)}/inventory`);
          if (invRes.ok) {
  ...
  const fetchWarehouseAlerts = async () => {
    try {
      const res = await fetch('https://44.205.22.2:8080/api/warehouses/alerts');
  ...
  const fetchStaffOrders = async () => {
    try {
      const res = await fetch('https://44.205.22.2:8080/api/staff/orders');
  ...
  const fetchStaffCustomers = async () => {
    try {
      const res = await fetch('https://44.205.22.2:8080/api/staff/customers');
  ...
  const handleViewOrderDetail = async (orderId) => {
    ...
    try {
      const res = await fetch(`https://44.205.22.2:8080/api/orders/${encodeURIComponent(orderId)}`, { headers });
      if (!res.ok) {
  ...
  const fetchProducts = async () => {
    try {
      const res = await fetch('https://44.205.22.2:8080/api/products');
